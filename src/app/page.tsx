...
const primaryFeatures = [
  {
    name: 'Curated Inventory',
    description:
      'Our handpicked selection includes modern furniture and premium materials sourced from top-tier manufacturers and surplus outlets.',
    href: '#',
    icon: HomeModernIcon,
  },
  {
    ...
    description:
      'We inspect every item for design, durability, and condition — so you get lasting value at a fraction of the original price.',
    href: '#',
  ...
  },
  {
    ...
    description:
      'Flexible options for pickup or drop-off make it easy to get your home upgrades when and where you need them.',
    href: '#',
    icon: TruckIcon,
  },
  {
    ...
    description:
      'Why pay retail? Our resale pricing gives you access to designer looks and materials for less — without cutting corners.',
    href: '#',
...
const stats = [
  { id: 1, name: 'Items Sold on Facebook', value: '300+' },
  { id: 2, name: '5-Star Ratings', value: '120+' },
  { id: 3, name: 'Repeat Customers', value: '80%' },
  { id: 4, name: 'Avg. Pickup Time', value: '< 24 hrs' },
]
    ...
    <div className="bg-gray-900">
      <main>
        ...
        <div className="relative isolate overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
            <div className="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8">
              ...
              Elevate Your Space with Timeless Home Upgrades
              </h1>
              <p className="mt-8 text-pretty text-lg font-medium text-gray-400 sm:text-xl/8">
              Premium furniture, tiles, and curated services — resold at unbeatable value.
              </p>
            ...
            <div className="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
              <div className="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                <img
                  alt="App screenshot"
                  src="https://images.unsplash.com/photo-1648475237029-7f853809ca14?q=80&w=1742&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  width={2432}
                  height={1442}
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          ...
          <h2 className="text-base/7 font-semibold text-indigo-400">Smart Home Upgrades</h2>
<p className="mt-2 text-pretty text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-balance">
Style and Value, Without Compromise
</p>
<p className="mt-6 text-lg/8 text-gray-300">
Discover modern furniture, designer materials, and renovation essentials — all at resale pricing. Thoughtfully curated for quality and affordability.
</p>
        ...
        {/* <div className="mt-32 sm:mt-56">
          ...
          <div className="relative overflow-hidden pt-16">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <img
                alt="App screenshot"
                src="https://images.unsplash.com/photo-1627831483163-bdf0d0b83732?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                width={2432}
                height={1442}
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
            <h2 className="text-base/8 font-semibold text-indigo-400">Local Trust. Real Results.</h2>
<p className="mt-2 text-pretty text-4xl font-semibold tracking-tight text-white sm:text-5xl">
  Backed by happy customers across Facebook Marketplace
</p>
<p className="mt-6 text-lg/8 text-gray-300">
  Every item we list is carefully curated and quickly claimed. Our fast-growing community of local buyers relies on Mod Haus for standout deals on quality home goods.
</p>
